...
public class DatasBeanDao extends AbstractDao<DatasBean, String> {
    ...
    public static class Properties {
        ...
        public final static Property ParseXML = new Property(29, int.class, "parseXML", false, "PARSE_XML");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DATAS_BEAN\" (" + //
                ...
                "\"PARSE_XML\" INTEGER NOT NULL );"); // 29: parseXML
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, DatasBean entity) {
        ...
        stmt.bindLong(30, entity.getParseXML());
    }
    ...
    public DatasBean readEntity(Cursor cursor, int offset) {
        DatasBean entity = new DatasBean( //
            ...
            cursor.getInt(offset + 29) // parseXML
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, DatasBean entity, int offset) {
        ...
        entity.setParseXML(cursor.getInt(offset + 29));
     }
